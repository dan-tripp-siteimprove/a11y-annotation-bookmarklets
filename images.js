...
(async function(bookmarkletVars) {
    ...
    function setAttr(elem_, attrName_, attrValue_) {
        let r = elem_.setAttribute(attrName_, attrValue_);
    }
    ...
    function run() {
        ...
        document.body.querySelectorAll("a[alt], button[alt], label[alt]").each((e) {
            e.before("<span class=\"altSpan\" style=\"color:black;font-weight:bold;font-family:sans-serif;font-size:small;background-color:yellow;speak:literal-punctuation;\"> INVALID❌alt=\"" + $(this).attr('alt') + "\" on " + $(this).prop("tagName") + "</span>");
        });
